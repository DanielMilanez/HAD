...
Como o hardware não está em sua posse, para verificar o funcionamento manipule os parâmetros do arquivo JSON e veja o resultado, para demonstrar legendas pressione a tecla de espaço, a IA nessa versão do front-end não está integrada, afinal sem o hardware não tem o porque utilizar algo além dessa versão simplificada.
